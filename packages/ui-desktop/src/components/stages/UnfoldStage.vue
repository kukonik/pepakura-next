<template>
  <div class="stage-root">
    <section class="left-panel">
      ...
      <div class="actions-group">
        <p class="group-title">Оптимизация</p>
        <div class="group-buttons">
          <button class="primary-btn" :disabled="!hasUnfold" @click="optimizeForPaper">
            Оптимизировать для бумаги
          </button>
        </div>
      </div>
...
// Состояние модального окна оптимизации
