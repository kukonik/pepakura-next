  ...
  <div class="app-root">
    ...
    >
      ...
      <div class="header-right">
        <span class="mode-chip">╨а╨╡╨╢╨╕╨╝: ╨Р╨▓╤В╨╛ (AI ╨┤╨╛╤Б╤В╤Г╨┐╨╡╨╜)</span>
      </div>
    </header>
    ...
    <div class="app-body" :class="{ 'app-body-full': fullscreenStage !== 'none' }">
      ...
      >
        <div class="sidebar-header">
          <p class="sidebar-title">╨Я╤А╨╛╨╡╨║╤В╤Л</p>
          <span class="sidebar-status">╤Б╨║╨╛╤А╨╛</span>
        </div>
        <p class="sidebar-empty">
          ╨Ч╨┤╨╡╤Б╤М ╨▒╤Г╨┤╤Г╤В ╤Б╨╛╤Е╤А╨░╨╜╤С╨╜╨╜╤Л╨╡ ╨┐╤А╨╛╨╡╨║╤В╤Л ╨╕ ╨╕╤Б╤В╨╛╤А╨╕╨╕ ╨│╨╡╨╜╨╡╤А╨░╤Ж╨╕╨╣.
        </p>
      </aside>
